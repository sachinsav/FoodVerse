      ...
      <nav className="flex justify-between items-center bg-orange-600 h-14 text-white ">
        ...
        <div className="h-full px-2 hidden sm:block">
          <ul className="flex items-center justify-center h-full">
            <li className="py-2 px-3 hover:bg-orange-100 hover:text-orange-600 h-full text-xl flex items-center">
              <a href="#">Home</a></li>
            <li className="py-2 px-3 hover:bg-orange-100 hover:text-orange-600 h-full text-xl flex items-center">AboutUs</li>
            <li className="py-2 px-3 hover:bg-orange-100 hover:text-orange-600 h-full text-xl flex items-center">Cart</li>
            <li className="py-2 px-3 hover:bg-orange-100 hover:text-orange-600 h-full text-xl flex items-center">LogIn</li>
          </ul>
        </div>
        ...
        {!showMenu && <div className="h-full flex items-center hover:bg-orange-100 hover:text-orange-600 px-2" onClick={menuIconClick}><MenuIcon fontSize="large"/></div>}
          ...
          {showMenu && <ul className="flex flex-col h-screen absolute right-0 top-0 w-4/6" id="sidebar" style={{backgroundColor : 'rgba(236, 117, 26, 0.6)', backdropFilter: 'blur(2px)'}}>
            ...
            <li className="p-2 hover:bg-orange-100 hover:text-orange-600 w-full text-xl">
              <a href="#">Home</a></li>
            <li className="p-2 hover:bg-orange-100 hover:text-orange-600 w-full text-xl">AboutUs</li>
            <li className="p-2 hover:bg-orange-100 hover:text-orange-600 w-full text-xl">Cart</li>
            <li className="p-2 hover:bg-orange-100 hover:text-orange-600 w-full text-xl">LogIn</li>
          </ul>}
        </div>
      </nav>
    </div>
